...
| `docs/flow-1-TheContract.md` | Flow 1 plain English overview — glossary, flow chart, UI spec, backend tables, pending issues |
| `docs/flow-2-TheUpload.md` | Flow 2 plain English overview — what the upload is, how it works, UI spec, backend tables, pending issues |
| `docs/flow-2-implementation-notes.md` | Flow 2 technical coding reference — Figma node IDs, field copy, form validation, tagging pipeline |
...
| Flow 2 — The Upload | In progress. See `docs/flow-2-TheUpload.md` |

...
class Contract(Base):
    ...
    path: Mapped[ContractPath] = mapped_column(Enum(ContractPath, native_enum=False))
    status: Mapped[ContractStatus] = mapped_column(Enum(ContractStatus, native_enum=False), index=True)

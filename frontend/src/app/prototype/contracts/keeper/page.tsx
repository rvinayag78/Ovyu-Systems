...
export default function PrototypeContractsKeeper() {
  return (
    <div style={{
      width: "1920px",
      height: "1080px",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: "25px", color: "#000", fontWeight: 400 }}>+</span>
            <span style={{ fontFamily: sans, fontWeight: 700, fontSize: "16px", color: "#000" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "row", gap: "64px", alignItems: "center" }}>
              <Link href="/prototype/contract/signed" style={{
                fontFamily: sans, fontStyle: "italic", fontWeight: 400, fontSize: "18px", color: "#1a1a1a",
                textDecoration: "none",
              }}>View</Link>
              <span style={{ fontFamily: sans, fontStyle: "italic", fontWeight: 400, fontSize: "18px", color: "#1a1a1a" }}>
                Download ⤓
              </span>
            </div>
          </div>

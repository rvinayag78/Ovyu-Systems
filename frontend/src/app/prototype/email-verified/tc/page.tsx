...
export default function PrototypeEmailVerifiedTC() {
  return (
    <div style={{
      width: "1920px",
      height: "1080px",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Link href="/prototype/contract/tc" style={{
            width: "304px",
            height: "48px",
            background: "#000",
            borderRadius: "8px",
          ...
          <p style={{
            ...
            Once you and your Transfer Contact have signed, the contract is locked and you can begin your upload.
          </p>
        </div>
      </div>
